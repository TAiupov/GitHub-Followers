...
class GFAlertVC: UIViewController {
    ...
    func configureTitleLabel() {
        ...
        titleLabel.text = alertTitle ?? "Somethimg went wrong"
    ...
    func configureMessageLabel() {
        ...
        NSLayoutConstraint.activate([messageLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 8),
